...
\sethead[\small{{\bf \thechapter~\chaptertitle}}]
[]
[\small{{\bf EPN, Facultad de Ciencias} \vspace{-6cm}\includegraphics[width=.05\textwidth]{graficos/Ciencias.png}}]
{\small{\vspace{-6cm}\includegraphics[width=.05\textwidth]{graficos/Ciencias.png} {\bf EPN, Facultad de Ciencias}}}
{}
...
[]
[\scriptsize{Instituto Ecuatoriano de Seguridad Social \vspace{-6cm}\includegraphics[width=.1\textwidth]{graficos/logo_iess_azul.png}}]
{\scriptsize{\vspace{-6cm}\includegraphics[width=.05\textwidth]{graficos/logo_iess_azul.png} Dirección Actuarial, de Investigación y Estadística }}
{}
